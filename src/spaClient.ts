...
export class SpaClient implements SpaController {
  ...
  getTargetTempHigh() {
    if (this.targetTempModeHigh === undefined) {
      return undefined;
    }
    return this.convertSpaTemperatureToExternal(this.targetTempModeHigh);
  }

  getTargetTempLow() {
    if (this.targetTempModeLow === undefined) {
      return undefined;
    }
    return this.convertSpaTemperatureToExternal(this.targetTempModeLow);
  }
